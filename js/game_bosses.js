    ...
    this.update = function ()
    {
        if (this.life > 0)
        {
            if (this.type == 0)
            {
                ...
                var patternCanvas = document.createElement ("canvas"), patternContext = patternCanvas.getContext ("2d");
                patternCanvas.width = 7;
                patternCanvas.height = 28;
                patternContext.shadowColor = "#00000066";
                patternContext.fillStyle = "#000";
                patternContext.fillRect (0, 0, 7, 28);
                patternContext.shadowColor = "transparent";
                patternContext.fillStyle = "#4A4A4A";
                patternContext.fillRect (0, 14, 7, 14);
                if (this.engine1Life == 0)
                {
                    patternContext.clearRect (0, 0, 7, 3);
                    patternContext.clearRect (0, 7, 7, 3);
                }
                ...
                patternContext.shadowColor = "#00000066";
                patternContext.fillStyle = "#000";
                patternContext.fillRect (0, 0, 28, 7);
                patternContext.shadowColor = "transparent";
                patternContext.fillStyle = "#4A4A4A";
                patternContext.fillRect (14, 0, 14, 7);
                if (this.engine2Life == 0) patternContext.clearRect (0, 4, 7, 3);
                this.pattern = ctx.createPattern (patternCanvas, "repeat");
                ctx.fillStyle = this.pattern;
                ...
                patternContext.fillStyle = "#4A4A4A";
                patternContext.fillRect (0, 14, 7, 14);
                if (this.engine3Life == 0) patternContext.clearRect (0, 4, 7, 3);
                this.pattern = ctx.createPattern (patternCanvas, "repeat");
                ctx.fillStyle = this.pattern;
                ...
                patternContext.fillStyle = "#4A4A4A";
                patternContext.fillRect (14, 0, 14, 7);
                if (this.engine4Life == 0) patternContext.clearRect (7, 0, 7, 3);
                this.pattern = ctx.createPattern (patternCanvas, "repeat");
                ctx.fillStyle = this.pattern;
