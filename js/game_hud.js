...
function scoreHud (gameShip)
{
    ...
    else
    {
        if (gameModes.findIndex (mode => mode.active == true) == 0)
        {
            if (document.getElementById ("scoreHud").innerHTML != gameShips [0].score) document.getElementById ("scoreHud").innerHTML = gameShips [0].score;
        }
        else
        {
            if (document.getElementById ("score" + gameShips [gameShip].name).innerHTML != gameShips [gameShip].score) document.getElementById ("score" + gameShips [gameShip].name).innerHTML = gameShips [gameShip].score;
        }
    }
} 
