...
function updateHuds (gameShip)
{
    ...
    document.getElementById ("hudsMulti").innerHTML += '<div class="multiHuds"><div class="lifeHud" title="' + gameShips [gameShip].name + ' Life: ' + gameShips [gameShip].life + '%"><div class="lifeHud2" style="width: ' + (gameShips [gameShip].life * 16 / 100) + 'px; background-color: ' + gameShips [gameShip].colors.near + ';"></div></div> <div class="fuelHud" title="' + gameShips [gameShip].name + ' Fuel: ' + gameShips [gameShip].fuel + '%"><div class="fuelHud2" style="width: ' + (gameShips [gameShip].fuel * 16 / 100) + 'px; background-color: ' + gameShips [gameShip].colors.near + ';"></div></div> <div class="ammoHud" title="' + gameShips [gameShip].name + ' Ammo: ' + gameShips [gameShip].ammo + '%"><div class="ammoHud2" style="width: ' + (gameShips [gameShip].ammo * 16 / 100) + 'px; background-color: ' + gameShips [gameShip].colors.near + ';"></div></div> <div class="shieldHud" title="' + gameShips [gameShip].name + ' Shield: ' + gameShips [gameShip].shield + '%"><div class="shieldHud2" style="width: ' + (gameShips [gameShip].shield * 16 / 100) + 'px; background-color: ' + gameShips [gameShip].colors.near + ';"></div></div> <div class="fa fa-' + speedIcon + ' multiHud" style="color: ' + gameShips [gameShip].colors.near + ';" title="' + gameShips [gameShip].name + ' Speed: ' + (speed * 300) + ' Km/h"></div> <div class="fa fa-' + zIcon + ' multiHud" style="color: ' + gameShips [gameShip].colors.near + ';" title="' + gameShips [gameShip].name + ' Altitude: ' + (gameShips [gameShip].z * 10) + ' m"></div> <div class="multiHud2" style="background-color: ' + gameShips [gameShip].colors.near + ';" title="' + gameShips [gameShip].name + ' Heading: ' + heading + 'º">' + headingIcon + '</div> <div class="multiHudWeapons" style="background-color: ' + gameShips [gameShip].colors.near + ';"><div class="multiHud3" style="border-right: solid 1px #000;" title="' + gameShips [gameShip].name + ' Laser"><div class="fa fa-burst" style="position: absolute; top: 4px; left: 3px;"></div>L<div class="fa fa-clock" style="position: absolute; top: 4px; right: 3px;"></div></div><div class="multiHud3" style="border-right: solid 1px #000;" title="' + gameShips [gameShip].name + ' Pulse">P</div><div class="multiHud3" style="border-right: solid 1px #000;" title="' + gameShips [gameShip].name + ' K-Can">K</div><div class="multiHud3" title="' + gameShips [gameShip].name + ' Hyper">H</div></div>';
}