...
function lifesHud (gameShip, ships)
{
    ...
    {
        document.getElementById ("lifesHud").innerHTML += '<svg id="life' + gameShips [gameShip].name + i + '" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 30" style="background-color: ' + gameShips [gameShip].invColor + '; border: solid 2px ' + gameShips [gameShip].invColor + ';"><title>' + gameShips [gameShip].name + ' Life ' + (i + 1) + '</title>' +
                                                          skin +
