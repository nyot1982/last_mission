...
function gamepadConnected (e)
{
    ...
    if (gameModes.findIndex (mode => mode.active == true) != 1 && gameModes.findIndex (mode => mode.active == true) != 2 && gameControl != newControl) changeControl (newControl, e.gamepad.index * 1);
...
function buttonDown (id_control, control, button)
{
    if (!buttonsPressed [id_control].includes (button))
    {
        ...
        if (gameModes.findIndex (mode => mode.active == true) != 1 && gameModes.findIndex (mode => mode.active == true) != 2 && gameControl != control) changeControl (control, id_control);
...
function keyDown (e)
{
    ...
    else if (!keysPressed.includes (e.keyCode))
    {
        ...
        if (gameModes.findIndex (mode => mode.active == true) != 1 && gameModes.findIndex (mode => mode.active == true) != 2 && gameControl != "keyboard") changeControl ("keyboard", -1);
