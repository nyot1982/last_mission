    ...
    else
    {
        ...
        else
        {
            ...
            else   
            {
                ...
                else $return ["player"] = [ 'id' => intval ($player ['id']), 'validated' => intval ($player ['validated']), 'email' => $player ['email'], 'name' => $player ['name'], 'password' => $player ['password'], 'color' => $player ['color'], 'skin' => null, 'skins' => $player ['skins'], 'xp' => $player ['xp'], 'game_music' => $player ['game_music'], 'game_sound' => $player ['game_sound'], 'user_actions' => $player ['user_actions'] ];
            }
            $resultado->free ();
        }
    }
