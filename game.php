                ...
                <div class="keys">
                    <div class="keysContent">
                        <div class="tabs">
                            ...
                            <div class="tab fixed"><a id="keyboard" href="javascript: changeControl ('keyboard', -1);" class="fa fa-keyboard active" title="Watch keyboard controls"></a><a id="gamepad" href="javascript: changeControl ('gamepad', null);" class="fa fa-gamepad-modern" style="display: none;"title="Watch gamepad controls"></a><a id="joystick" href="javascript: changeControl ('joystick', null);" class="fa fa-joystick" style="display: none;" title="Watch joystick controls"></a></div><a title="Mouse interaction" class="fa fa-mouse fa-beat interaction" style="position: absolute; right: 4px; bottom: 7px;"></a>
                        </div>
